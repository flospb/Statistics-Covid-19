...
Да, я каюсь за это, но все найденные/нагугленные решения данной проблемы сводились к сделать чистую сборку, перезапуск, С чем это связано, я так и не понял и надеюсь, что при проверке данная ошибки не возникнет и проблема локальная (только у меня из Кешей или чего-то другого).

Проект выполнял, разбивая его на подзадачи, вел в Trello. Всего выполнено 44 задачи, отказ от 11 задач (не успею, не рационально и пр.).
