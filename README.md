...
На данном экране отображается информация о симптомах болезни, а так же рекомендации по противодействию распространения вируса. На скриншоте 2 демостриется наличие scrollView.
