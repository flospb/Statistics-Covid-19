...
Если вдруг при сборке приложения появится ошибка «Command CompileAssetCatalog failed with a nonzero exit code», то достаточно сделать Clean build и запустить приложение. 
